...
async fn root_role() {
    ...
    let read = ReadBuilder::new()
        ...
        .await
        .expect("should create read");
    let reply = node.request(read).owner(alice.did()).await.expect("should configure protocol");
    assert_eq!(reply.status, StatusCode::OK);
}
...
async fn context_role() {
    ...
    let participant = WriteBuilder::new()
        ...
        .await
        .expect("should create write");
    let reply = node.request(participant.clone()).owner(alice.did()).await.expect("should write");
    assert_eq!(reply.status, StatusCode::ACCEPTED);
...
async fn invalid_context_role() {
    ...
    let thread_1 = WriteBuilder::new()
        ...
        .await
        .expect("should create write");
    let reply = node.request(thread_1.clone()).owner(alice.did()).await.expect("should write");
    assert_eq!(reply.status, StatusCode::ACCEPTED);
    ...
    let thread_2 = WriteBuilder::new()
        ...
        .await
        .expect("should create write");
    let reply = node.request(thread_2.clone()).owner(alice.did()).await.expect("should write");
    assert_eq!(reply.status, StatusCode::ACCEPTED);
...
async fn decrypt_context() {
    ...
    let configure_alice = ConfigureBuilder::new()
        ...
        .expect("should build");
    let reply =
        node.request(configure_alice).owner(alice.did()).await.expect("should configure protocol");
    assert_eq!(reply.status, StatusCode::ACCEPTED);
    ...
    let configure_bob = ConfigureBuilder::new()
        ...
        .expect("should build");
    let reply =
        node.request(configure_bob).owner(bob.did()).await.expect("should configure protocol");
    assert_eq!(reply.status, StatusCode::ACCEPTED);
    ...
    let reply = node.request(query).owner(alice.did()).await.expect("should match");
    assert_eq!(reply.status, StatusCode::OK);
    ...
    let reply = node.request(read.clone()).owner(bob.did()).await.expect("should write");
    assert_eq!(reply.status, StatusCode::OK);
...
async fn invalid_signature() {
    ...
    let Err(Error::Unauthorized(e)) = node.request(read).owner(alice.did()).await else {
