...
impl<S: Signature> GrantBuilder<Grantee, Scoped, Signed<'_, S>> {
...
impl<S: Signature> RequestBuilder<Scoped, Signed<'_, S>> {
...
impl<S: Signature> RevocationBuilder<Grant, Signed<'_, S>> {
